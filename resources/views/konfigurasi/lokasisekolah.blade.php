                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $lokasi_sekolah->lokasi_sekolah }}" id="lokasi_sekolah" name="lokasi_sekolah" class="form-control" placeholder="Lokasi Sekolah">
                                              </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $lokasi_sekolah->radius}}" id="radius" name="radius" class="form-control" placeholder="Radius">
                                              </div>
                                        </div>
                                    </div>
                                </div>
