                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nis') }}" id="nis" name="nis" class="form-control" placeholder="NIS">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nama_lengkap') }}" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama Siswa">
                            </div>
                        </div>
                        <div class="col-3">
